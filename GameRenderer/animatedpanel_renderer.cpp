...
void AnimatedPanelRenderer::RenderObjects()
{
  ...
  g_app->m_renderer->Clip(m_screenX + 1, m_screenY - m_titleH + 1, m_screenW - 1, m_screenH + m_titleH + m_captionH - 1);
      ...
      if (success)
      {
        ...
        case AnimatedPanelKeyframe::ColourEnemy:
        {
          for (int i = 0; i < NUM_TEAMS; ++i)
          {
            ...
            if (team->m_teamType != TeamTypeUnused && !g_app->m_location->IsFriend(g_app->m_globalWorld->m_myTeamId, i))
            {

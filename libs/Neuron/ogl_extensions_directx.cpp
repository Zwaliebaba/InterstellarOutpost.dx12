...
void __stdcall glBindBufferD3D (GLenum _target, GLuint _bufferId)
{
	...
	AppDebugAssert( _target == GL_ARRAY_BUFFER_ARB );
...
void __stdcall glBufferDataD3D (GLenum _target, GLsizeiptrARB _size, const GLvoid *_data, GLenum _usage)
{
	...
	AppDebugAssert( g_currentVertexBuffer != NULL );
...
{
	if (strcmp( extension, "GL_ARB_multitexture" ) == 0 || strcmp( extension, "GL_ARB_vertex_buffer_object" ) == 0)
		return 1;
	return 0;
}
#endif // USE_DIRECT3D

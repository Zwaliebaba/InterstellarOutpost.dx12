...
DPadMovement::DPadMovement(ControlType _north, ControlType _south, ControlType _east, ControlType _west, int _sensitivity)
  : Movement3D(),
    north(_north),
    south(_south),
    east(_east),
...
DPadMovement::DPadMovement(ControlType _north, ControlType _south, ControlType _east, ControlType _west, ControlType _up,
                           ControlType _down, int _sensitivity)
  : Movement3D(),
    north(_north),
    south(_south),
    east(_east),
...
PriorityMovement2D::PriorityMovement2D(std::unique_ptr<Movement2D> _first, std::unique_ptr<Movement2D> _second)

...
// LegacyTexture env parameter
#define GL_TEXTURE_ENV_MODE               0x2200
#define GL_TEXTURE_ENV_COLOR              0x2201

// LegacyTexture env mode
#define GL_MODULATE                       0x2100
#define GL_DECAL                          0x2101
#define GL_REPLACE                        0x1E01

// LegacyTexture Min Filter
#define GL_NEAREST_MIPMAP_LINEAR          0x2702
#define GL_LINEAR_MIPMAP_LINEAR           0x2703

// LegacyTexture Mag Filter
#define GL_NEAREST                        0x2600
#define GL_LINEAR                         0x2601

// LegacyTexture Wrap Mode
...
inline void XM_CALLCONV glColor(XMVECTOR _color)
{
  glColor4f(XMVectorGetX(_color), XMVectorGetY(_color), XMVectorGetZ(_color), XMVectorGetW(_color));
}
...
void glPopMatrix();
void glLoadIdentity();
void glLoadMatrixd(const float* m);

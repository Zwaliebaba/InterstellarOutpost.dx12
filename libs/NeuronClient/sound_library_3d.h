...
class SoundLibrary3d
{
  protected:
    ...
    int m_sampleRate;
    int m_masterVolume;
    LegacyVector3 m_listenerPos;			// Records the most recent value passed into SetListenerPos
  ...
  public:
    ...
    virtual void Initialize(int _mixFreq, int _numChannels, bool hw3d, int _mainBufNumSamples, int _musicBufNumSamples) = 0;
    ...
    virtual void SetChannelPosition(int _channel, const LegacyVector3& _pos, const LegacyVector3& _vel) = 0;
    ...
    virtual void EnableDspFX(int _channel, int _numFilters, const int* _filterTypes) = 0;
    virtual void UpdateDspFX(int _channel, int _filterType, int _numParams, const float* _params) = 0;
    virtual void DisableDspFX(int _channel) = 0;

    virtual void SetListenerPosition(const LegacyVector3& _pos, const LegacyVector3& _front, const LegacyVector3& _up,
                                     const LegacyVector3& _vel) = 0;

...
namespace OpenGLD3D
{
  ...
  class DisplayListDevice : public IDirect3DDevice9
  {
    ...
    STDMETHOD(CreateTexture)(UINT Width, UINT Height, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool,
                             IDirect3DTexture9** ppTexture, HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(CreateVolumeTexture)(UINT Width, UINT Height, UINT Depth, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool,
                                   IDirect3DVolumeTexture9** ppVolumeTexture, HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(CreateCubeTexture)(UINT EdgeLength, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool,
                                 IDirect3DCubeTexture9** ppCubeTexture, HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(CreateVertexBuffer)(UINT Length, DWORD Usage, DWORD FVF, D3DPOOL Pool, IDirect3DVertexBuffer9** ppVertexBuffer,
                                  HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(CreateIndexBuffer)(UINT Length, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DIndexBuffer9** ppIndexBuffer,
                                 HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    ...
    STDMETHOD(CreateDepthStencilSurface)(UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample,
                                         ...
                                         HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(UpdateSurface)(IDirect3DSurface9* pSourceSurface,CONST RECT* pSourceRect, IDirect3DSurface9* pDestinationSurface,
                             CONST POINT* pDestPoint) DLIST_DEV_NOT_IMPLEMENTED;
    ...
    STDMETHOD(StretchRect)(IDirect3DSurface9* pSourceSurface,CONST RECT* pSourceRect, IDirect3DSurface9* pDestSurface,
                           CONST RECT* pDestRect, D3DTEXTUREFILTERTYPE Filter) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(ColorFill)(IDirect3DSurface9* pSurface,CONST RECT* pRect, D3DCOLOR color) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(CreateOffscreenPlainSurface)(UINT Width, UINT Height, D3DFORMAT Format, D3DPOOL Pool, IDirect3DSurface9** ppSurface,
                                           HANDLE* pSharedHandle) DLIST_DEV_NOT_IMPLEMENTED;
    ...
    STDMETHOD(DrawIndexedPrimitive)(D3DPRIMITIVETYPE, INT BaseVertexIndex, UINT MinVertexIndex, UINT NumVertices, UINT startIndex,
                                    UINT primCount) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(DrawIndexedPrimitiveUP)(D3DPRIMITIVETYPE PrimitiveType, UINT MinVertexIndex, UINT NumVertices, UINT PrimitiveCount,
                                      CONST void* pIndexData, D3DFORMAT IndexDataFormat,CONST void* pVertexStreamZeroData,
                                      UINT VertexStreamZeroStride) DLIST_DEV_NOT_IMPLEMENTED;
    STDMETHOD(ProcessVertices)(UINT SrcStartIndex, UINT DestIndex, UINT VertexCount, IDirect3DVertexBuffer9* pDestBuffer,
                               IDirect3DVertexDeclaration9* pVertexDecl, DWORD Flags) DLIST_DEV_NOT_IMPLEMENTED;
    ...
    public:
      ...
      void RecordLoadTransform(MatrixStack* _matrixStack, const D3DXMATRIX& _mat);
      void RecordPushMatrix(MatrixStack* _matrixStack);
      void RecordPopMatrix(MatrixStack* _matrixStack);
      void RecordMultMatrix(MatrixStack* _matrixStack, const D3DXMATRIX& _mat);

...
#include "Shaders/Compiled/FXAAPass1_Luma_CS.h"
#include "Shaders/Compiled/FXAAPass1_RGB_CS.h"
#include "Shaders/Compiled/FXAAPass2HCS.h"
#include "Shaders/Compiled/FXAAPass2HDebugCS.h"
#include "Shaders/Compiled/FXAAPass2VCS.h"
#include "Shaders/Compiled/FXAAPass2VDebugCS.h"

// These shaders are when typed UAV loads of complex formats is available
#include "Shaders/Compiled/FXAAPass1_Luma2_CS.h"
#include "Shaders/Compiled/FXAAPass1_RGB2_CS.h"
#include "Shaders/Compiled/FXAAPass2H2CS.h"
#include "Shaders/Compiled/FXAAPass2HDebug2CS.h"
#include "Shaders/Compiled/FXAAPass2V2CS.h"
#include "Shaders/Compiled/FXAAPass2VDebug2CS.h"

#include "Shaders/Compiled/FXAAResolveWorkQueueCS.h"
...
void FXAA::Render(ComputeContext &Context, bool bUsePreComputedLuma)
{
  ...
  if (ForceOffPreComputedLuma) bUsePreComputedLuma = false;

...
#include "Shaders/Compiled/BoundNeighborhoodCS.h"
#include "Shaders/Compiled/CameraMotionBlurPrePassCS.h"
#include "Shaders/Compiled/CameraMotionBlurPrePassLinearZCS.h"
#include "Shaders/Compiled/CameraVelocityCS.h"
#include "Shaders/Compiled/MotionBlurFinalPassCS.h"
#include "Shaders/Compiled/MotionBlurFinalPassPS.h"
#include "Shaders/Compiled/MotionBlurPrePassCS.h"
#include "Shaders/Compiled/ScreenQuadCommonVS.h"
#include "Shaders/Compiled/TemporalBlendCS.h"
...
#define CreatePSO(ObjName, ShaderByteCode)                                                                                                           \
  ...
  if (g_bTypedUAVLoadSupport_R11G11B10_FLOAT) { CreatePSO(s_MotionBlurFinalPassCS, g_pMotionBlurFinalPassCS); }
  else
  {
                                              ...
                                              bool UseLinearZ)
{
  ...
  if (UseLinearZ) Context.TransitionResource(LinearDepth, D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE);
  else

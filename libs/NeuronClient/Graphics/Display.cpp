...
#include "Shaders/Compiled/BlendUIHDRPS.h"
#include "Shaders/Compiled/BufferCopyPS.h"
#include "Shaders/Compiled/CompositeHDRPS.h"
#include "Shaders/Compiled/CompositeSDRPS.h"
#include "Shaders/Compiled/GenerateMipsGammaCS.h"
#include "Shaders/Compiled/GenerateMipsGammaOddCS.h"
#include "Shaders/Compiled/GenerateMipsGammaOddXCS.h"
#include "Shaders/Compiled/GenerateMipsGammaOddYCS.h"
#include "Shaders/Compiled/GenerateMipsLinearCS.h"
#include "Shaders/Compiled/GenerateMipsLinearOddCS.h"
#include "Shaders/Compiled/GenerateMipsLinearOddXCS.h"
#include "Shaders/Compiled/GenerateMipsLinearOddYCS.h"
#include "Shaders/Compiled/MagnifyPixelsPS.h"
#include "Shaders/Compiled/PresentHDRPS.h"
#include "Shaders/Compiled/PresentSDRPS.h"
#include "Shaders/Compiled/ScaleAndCompositeHDRPS.h"
#include "Shaders/Compiled/ScaleAndCompositeSDRPS.h"
#include "Shaders/Compiled/ScreenQuadPresentVS.h"
...
namespace Graphics
{
  ...
  void SetDisplayResolution(void)
  {
    ...
    if (SelectedDisplayRes == DisplayResolution) return;
...
void Display::Shutdown(void)
{
  ...
  for (UINT i = 0; i < SWAP_CHAIN_BUFFER_COUNT; ++i) g_DisplayPlane[i].Destroy();
...
void Graphics::PreparePresentSDR(void)
{
  ...
  else
  {
    ...
    // Scale or Copy
    if (NeedsScaling) { ImageScaling::Upscale(Context, Dest, g_SceneColorBuffer, eScalingFilter((int) UpsampleFilter)); }
    else
    {
...
{
  if (g_bEnableHDROutput) PreparePresentHDR();
  else
    PreparePresentSDR();
  ...
  if (s_EnableVSync)
  {
    ...
    if (s_DropRandomFrames)
    {
      if (std::rand() % 50 == 0) s_FrameTime += (1.0f / 60.0f);
    }
  }
  else
  {

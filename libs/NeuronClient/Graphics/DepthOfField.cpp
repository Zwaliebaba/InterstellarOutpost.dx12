...
#include "Shaders/Compiled/DoFCombine2CS.h"
#include "Shaders/Compiled/DoFCombineCS.h"
#include "Shaders/Compiled/DoFCombineFast2CS.h"
#include "Shaders/Compiled/DoFCombineFastCS.h"
#include "Shaders/Compiled/DoFDebugBlueCS.h"
#include "Shaders/Compiled/DoFDebugGreenCS.h"
#include "Shaders/Compiled/DoFDebugRedCS.h"
#include "Shaders/Compiled/DoFMedianFilterCS.h"
#include "Shaders/Compiled/DoFMedianFilterFixupCS.h"
#include "Shaders/Compiled/DoFMedianFilterSepAlphaCS.h"
#include "Shaders/Compiled/DoFPass1CS.h"
#include "Shaders/Compiled/DoFPass2CS.h"
#include "Shaders/Compiled/DoFPass2DebugCS.h"
#include "Shaders/Compiled/DoFPass2FastCS.h"
#include "Shaders/Compiled/DoFPass2FixupCS.h"
#include "Shaders/Compiled/DoFPreFilterCS.h"
#include "Shaders/Compiled/DoFPreFilterFastCS.h"
#include "Shaders/Compiled/DoFPreFilterFixupCS.h"
#include "Shaders/Compiled/DoFTilePassCS.h"
#include "Shaders/Compiled/DoFTilePassFixupCS.h"
...
void DepthOfField::Render(CommandContext &BaseContext, float /*NearClipDist*/, float FarClipDist)
{
  ...
  DoFConstantBuffer cbuffer = {(float) FocalDepth,
                               1.0f / (float) FocalRange,
                               ...
                               BufferWidth,
                               BufferHeight,
                               (int32_t) Math::DivideByMultiple(BufferWidth, 2),
                               (int32_t) Math::DivideByMultiple(BufferHeight, 2),
                               TiledWidth,
                               TiledHeight,
                               1.0f / TiledWidth,
                               1.0f / TiledHeight,
                               (uint32_t) DebugMode,
                               EnablePreFilter ? 0u : 1u,
                               ForegroundRange / FarClipDist,
                               FarClipDist / ForegroundRange,
                               (float) AntiSparkleWeight};
...

  {
    ...
    if (ForceFast && !DebugMode) Context.SetPipelineState(s_DoFPreFilterFastCS);
    else
    ...
    if (!ForceSlow && !DebugMode) Context.SetPipelineState(s_DoFPreFilterFastCS);
...

  {
    ...
    if (ForceFast && !DebugMode) Context.SetPipelineState(s_DoFPass2FastCS);
    else
    ...
    if (!ForceSlow && !DebugMode) Context.SetPipelineState(s_DoFPass2FastCS);
    Context.SetDynamicDescriptor(1, 3, g_DoFFastQueue.GetSRV());
    Context.DispatchIndirect(s_IndirectParameters, 12);

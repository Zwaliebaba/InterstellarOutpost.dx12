...
#include "Shaders/Compiled/ParticleBinCullingCS.h"
#include "Shaders/Compiled/ParticleDispatchIndirectArgsCS.h"
#include "Shaders/Compiled/ParticleFinalDispatchIndirectArgsCS.h"
#include "Shaders/Compiled/ParticleLargeBinCullingCS.h"
#include "Shaders/Compiled/ParticleSpawnCS.h"
#include "Shaders/Compiled/ParticleUpdateCS.h"

#include "Shaders/Compiled/ParticleTileRenderCS.h"
#include "Shaders/Compiled/ParticleTileRenderFastCS.h"
#include "Shaders/Compiled/ParticleTileRenderFastDynamicCS.h"
#include "Shaders/Compiled/ParticleTileRenderFastLowResCS.h"
#include "Shaders/Compiled/ParticleTileRenderSlowDynamicCS.h"
#include "Shaders/Compiled/ParticleTileRenderSlowLowResCS.h"

#include "Shaders/Compiled/ParticleTileRender2CS.h"
#include "Shaders/Compiled/ParticleTileRenderFast2CS.h"
#include "Shaders/Compiled/ParticleTileRenderFastDynamic2CS.h"
#include "Shaders/Compiled/ParticleTileRenderFastLowRes2CS.h"
#include "Shaders/Compiled/ParticleTileRenderSlowDynamic2CS.h"
#include "Shaders/Compiled/ParticleTileRenderSlowLowRes2CS.h"

#include "Shaders/Compiled/ParticleDepthBoundsCS.h"
#include "Shaders/Compiled/ParticleTileCullingCS.h"

#include "Shaders/Compiled/ParticleNoSortVS.h"
#include "Shaders/Compiled/ParticlePS.h"
#include "Shaders/Compiled/ParticlePreSortCS.h"
#include "Shaders/Compiled/ParticleSortIndirectArgsCS.h"
#include "Shaders/Compiled/ParticleVS.h"
...
#undef CreatePSO
  ...
  if (s_ReproFrame > 0) s_RNG.SetSeed(1);
...
{
  if (!s_InitComplete) return EFFECTS_ERROR;
...
{
  if (!Enable || !s_InitComplete || ParticleEffectsActive.size() == 0) return;

  ScopedTimer _prof(L"Particle Update", Context);

  if (++TotalElapsedFrames == s_ReproFrame) PauseSim = true;

  if (PauseSim) return;

  Context.ResetCounter(SpriteVertexBuffer);

  if (ParticleEffectsActive.size() == 0) return;
                                   ...
                                   ColorBuffer &LinearDepth)
{
  ...
  ASSERT(Width == DepthTarget.GetWidth() && Height == DepthTarget.GetHeight() && Width == LinearDepth.GetWidth() && Height == LinearDepth.GetHeight(),
...
{
  if (!s_InitComplete || ParticleEffectsActive.size() == 0 || PauseSim || EffectID >= ParticleEffectsActive.size()) return;
...
{
  if (!s_InitComplete || ParticleEffectsActive.size() == 0 || PauseSim || EffectID >= ParticleEffectsActive.size()) return -1.0;

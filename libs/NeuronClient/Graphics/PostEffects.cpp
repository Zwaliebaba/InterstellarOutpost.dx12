...
#include "Shaders/Compiled/AdaptExposureCS.h"
#include "Shaders/Compiled/ApplyBloom2CS.h"
#include "Shaders/Compiled/ApplyBloomCS.h"
#include "Shaders/Compiled/AverageLumaCS.h"
#include "Shaders/Compiled/BloomExtractAndDownsampleHdrCS.h"
#include "Shaders/Compiled/BloomExtractAndDownsampleLdrCS.h"
#include "Shaders/Compiled/BlurCS.h"
#include "Shaders/Compiled/CopyBackPostBufferCS.h"
#include "Shaders/Compiled/DebugDrawHistogramCS.h"
#include "Shaders/Compiled/DebugLuminanceHdr2CS.h"
#include "Shaders/Compiled/DebugLuminanceHdrCS.h"
#include "Shaders/Compiled/DebugLuminanceLdr2CS.h"
#include "Shaders/Compiled/DebugLuminanceLdrCS.h"
#include "Shaders/Compiled/DownsampleBloomAllCS.h"
#include "Shaders/Compiled/DownsampleBloomCS.h"
#include "Shaders/Compiled/ExtractLumaCS.h"
#include "Shaders/Compiled/GenerateHistogramCS.h"
#include "Shaders/Compiled/ToneMap2CS.h"
#include "Shaders/Compiled/ToneMapCS.h"
#include "Shaders/Compiled/ToneMapHDR2CS.h"
#include "Shaders/Compiled/ToneMapHDRCS.h"
#include "Shaders/Compiled/UpsampleAndBlurCS.h"
...
void PostEffects::ProcessHDR(ComputeContext &Context)
{
  ...
  if (g_bTypedUAVLoadSupport_R11G11B10_FLOAT) Context.TransitionResource(g_SceneColorBuffer, D3D12_RESOURCE_STATE_UNORDERED_ACCESS);
  else
  ...
  if (g_bTypedUAVLoadSupport_R11G11B10_FLOAT) Context.SetDynamicDescriptor(1, 0, g_SceneColorBuffer.GetUAV());
  else
  {
...
void PostEffects::ProcessLDR(CommandContext &BaseContext)
{
  ...
  if (bGenerateBloom) GenerateBloom(Context);
...
void PostEffects::Render(void)
{
  ...
  if (EnableHDR && !SSAO::DebugDraw && !(DepthOfField::Enable && DepthOfField::DebugMode >= 3)) ProcessHDR(Context);
  else
    ProcessLDR(Context);

  bool bGeneratedLumaBuffer = EnableHDR || FXAA::DebugDraw || BloomEnable;
  if (FXAA::Enable) FXAA::Render(Context, bGeneratedLumaBuffer);
  ...
  if (!g_bTypedUAVLoadSupport_R11G11B10_FLOAT) CopyBackPostBuffer(Context);

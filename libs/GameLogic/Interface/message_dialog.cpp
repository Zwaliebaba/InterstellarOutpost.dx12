...
void MessageDialog::Create()
{
    ...
    {
        temp = LANGUAGEPHRASE("dialog_close");
    }
    else
    {
        temp = UnicodeString( "Close" );
    }

    button->SetShortProperties( "dialog_close", (m_w - buttonWidth)/2, m_h - GetMenuSize(30), buttonWidth, buttonHeight, temp );

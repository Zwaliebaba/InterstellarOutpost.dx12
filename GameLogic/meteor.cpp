...
bool Meteor::AdvanceToTarget()
{
  ...
  double speed = EntityBlueprint::GetStat(TypeMeteor, StatSpeed);
  ...
  return ((m_pos - m_targetPos).Mag() < 10.0f || m_pos.y < g_app->m_location->m_landscape.m_heightMap->GetValue(m_pos.x, m_pos.z));
}

...
public:
	...
	static void LoadPrologue()
	{
		...
		if( gloc == NULL )
		{
			...
			DebugTrace("Failed to find launchpad level in the global world.\n");
			return;
		}

		ASSERT_TEXT( gloc != NULL, "Unable to find launchpad level in the global world." );
    ...
    void MouseUp()
    {
		DebugTrace("Prologue Button Pressed. Time = %f\n", GetHighResTime() );

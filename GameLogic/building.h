...
class Building : public WorldObject
{
  public:
    ...
    {
      TypeInvalid,
      // When you add an entry here remember to update building.cpp
      TypeFactory,
      // 1	
      TypeCave,
      // 2
  ...
  public:
    ...
    Vector3 PushFromBuilding(const Vector3& _pos, double _radius);
    ...
    virtual bool DoesSphereHit(const Vector3& _pos, double _radius);

...
class FileDialog : public DarwiniaWindow
{
  public:
    ...
    FileDialog(const char* name, const char* parent, const char* path = nullptr, const char* filter = nullptr,
    ...
    virtual void FileSelected(const char* filename); // This will be called for all selected files
};

...
//        case CrateRewardFormationIncrease:  RunFormtationIncrease( m_id.GetTeamId() );      messageShown = true;      break;
        ...
        default:    ASSERT_TEXT(false, "Undefined Crate Reward in CaptureCrate(): id = %d", rewardId );  break;
    };
...
//        case CrateRewardTheBeast:           RunTheBeast( m_pos );                                               break;
        ...
        default:    ASSERT_TEXT(false, "Undefined Crate Reward in RunCaptureCrate(int): id = %d", _crateId );  break;
    }
}
...
void Crate::RunUncapturedCrate( int _teamId )
{
    ...
    switch( rewardId )
    {
        ...
        default:    ASSERT_TEXT(false, "Undefined Crate Reward in RunUncapturedCrate(): id = %d", rewardId );  break;
    }
}
...
WorldObjectId Crate::RunAirStrike( Vector3 const &_pos, int _teamId, bool _special )
{
    ...
    for( int i = 0; i < numMarkers; ++i )
    {
        ...
        //DebugTrace("Marker %d Created at x:%2.2f y:%2.2f z:%2.2f\n", i+1, targetPos.x, targetPos.y, targetPos.z );
    }
...
char *Crate::LogState( char *_message )
{
    ...
    sprintf( s_result, "%sCRATE Id[%d] pos[%5.2f,%5.2f,%5.2f], vel[%5.2f] radius[%5.2f]",
        (_message)?_message:"",
        m_id.GetUniqueId(),
        m_pos.x,
        m_pos.y,

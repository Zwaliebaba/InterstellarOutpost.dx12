...
class Darwinian : public Entity
{
  ...
  public:
    ...
    Vector3 PushFromObstructions(const Vector3& pos, bool killem = true) override;

    void GiveOrders(const Vector3& _targetPos, int routeId = -1);
    ...
    void FireSubversion(const Vector3& _pos);

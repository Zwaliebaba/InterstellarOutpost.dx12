...
class ClientToServer
{
  ...
  public:
    ...
    void RequestAimBuilding(unsigned char _teamId, int _buildingId, const Vector3& _pos);
    void RequestToggleFence(int _buildingId);

    void RequestRunProgram(unsigned char _teamId, unsigned char _program);
    void RequestTargetProgram(unsigned char _teamId, unsigned char _program, const Vector3& _pos);
    ...
    void RequestSelectDarwinians(unsigned char _teamId, const Vector3& _pos, float _radius);
    void RequestIssueDarwinanOrders(unsigned char _teamId, const Vector3& _pos, bool directRoute);
    void RequestOfficerOrders(unsigned char _teamId, const Vector3& _pos, bool directRoute, bool forceOnlyMove);
    void RequestArmourOrders(unsigned char _teamId, const Vector3& _pos, bool deployAtWaypoint);
    ...
    void SendIAmAlive(unsigned char _teamId, const TeamControls& _teamControls);

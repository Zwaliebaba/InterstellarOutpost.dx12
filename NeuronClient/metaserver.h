...
Directory* MetaServer_RequestData(const char* _dataType, const char* _lang = nullptr);
...
Directory* MetaServer_GetServer(char* _ip, int _port, bool _authRequired); // A copy is created and returned

LList<Directory*>* MetaServer_GetServerList(bool authRequired = false,
                                            bool wanServers = true, bool lanServers = true,
...
// Performs one iteration of a bubble-sort (into joinability order)                                                            

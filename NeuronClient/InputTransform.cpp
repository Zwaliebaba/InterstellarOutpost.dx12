...
ToggleInputTransform::ToggleInputTransform(ControlType _on, ControlType _off)
  : m_on(new ControlEventFunctor(_on)),
    m_off(new ControlEventFunctor(_off)),
    m_state(false),
    m_change(false) {}

ToggleInputTransform::ToggleInputTransform(std::unique_ptr<InputTransform> _on, std::unique_ptr<InputTransform> _off)
  : m_on(std::move(_on)),
    m_off(std::move(_off)),
    m_state(false),
    m_change(false) {}
...
bool ToggleInputTransform::operator()() { return on(); }

...
template <class T>
SliceDArray<T>::SliceDArray() : FastDArray<T>(), totalNumSlices(0), lastSlice(-1), lastUpdated(0)
{}

template <class T>
SliceDArray<T>::SliceDArray(int _totalNumSlices) : FastDArray<T>(), totalNumSlices(_totalNumSlices), lastSlice(-1), lastUpdated(0)
{}

template <class T>
SliceDArray<T>::SliceDArray(int _totalNumSlices, int newstepsize)
    : FastDArray<T>(newstepsize), totalNumSlices(_totalNumSlices), lastSlice(-1), lastUpdated(0)
{}

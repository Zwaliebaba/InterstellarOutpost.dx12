...
void Demo2Tutorial::TriggerChapter( int _chapter )
{
    ...
    switch( m_chapter )
    {
        case 1:         g_app->m_sepulveda->Say( "launchpad_tutorial_1" );
						...
						g_app->m_controlHelpSystem->ClearOnScreenAids();
						g_app->m_controlHelpSystem->AddOnScreenAid("button_la", "button_control_shadow", 
							LANGUAGEPHRASE("control_help_cameramove"), ControlCameraMove);
						g_app->m_controlHelpSystem->AddOnScreenAid("button_ra", "button_control_shadow", 
							LANGUAGEPHRASE("control_help_cameraturn"), ControlTargetMoveSecondary);
                        break;

        case 2:         g_app->m_sepulveda->Say( "launchpad_tutorial_3" );                                        
                        RepeatMessage( "launchpad_tutorial_3" );   
						g_app->m_controlHelpSystem->AddOnScreenAid("button_rt", "button_trigger_shadow", 
							LANGUAGEPHRASE("control_help_cameraup"), ControlCameraUp);
						g_app->m_controlHelpSystem->AddOnScreenAid("button_lt", "button_trigger_shadow", 
							LANGUAGEPHRASE("control_help_cameradown"), ControlCameraDown);
                        break;

        case 3:         g_app->m_sepulveda->Say( "launchpad_tutorial_4" );
                        RepeatMessage( "launchpad_tutorial_4" );
						g_app->m_controlHelpSystem->AddOnScreenAid("button_x", "button_abxy_shadow", 
							LANGUAGEPHRASE("control_help_quickunitstart"), ControlIconsTaskManagerDisplayPressed);
                        break;

        case 4:         g_app->m_sepulveda->Say( "launchpad_tutorial_5" );
                        RepeatMessage( "launchpad_tutorial_5" );
						g_app->m_controlHelpSystem->AddOnScreenAid("button_a", "button_abxy_shadow", 
							LANGUAGEPHRASE("control_help_quickunitcreate"), ControlUnitCreate, new BoolChecker<ControlHelpSystem>(&ControlHelpSystem::HasSquadRunning, g_app->m_controlHelpSystem));
                        break;
        ...
        case 5:
        {
                        ...
                        g_app->m_camera->SetTarget( building->m_pos - building->m_front * 50.0f, 400, 300 );  
        ...
        case 6:         g_app->m_camera->RequestMode(Camera::ModeFreeMovement);
						...
						g_app->m_controlHelpSystem->AddOnScreenAid("button_a", "button_abxy_shadow", 
							LANGUAGEPHRASE("control_help_quickunitplace"), ControlUnitCreate);
                        break;

        case 7:         g_app->m_sepulveda->Say( "launchpad_tutorial_7" );
                        RepeatMessage( "launchpad_tutorial_7" );
						g_app->m_controlHelpSystem->AddOnScreenAid("button_la", "button_control_shadow", 
							LANGUAGEPHRASE("control_help_move"), ControlUnitMove);
						g_app->m_controlHelpSystem->AddOnScreenAid("button_lt", "button_trigger_shadow", 
							LANGUAGEPHRASE("control_help_camerarotateleft"), ControlCameraRotateLeft);
						g_app->m_controlHelpSystem->AddOnScreenAid("button_rt", "button_trigger_shadow", 
							LANGUAGEPHRASE("control_help_camerarotateright"), ControlCameraRotateRight);
                        break;

        case 8:         g_app->m_sepulveda->Say( "launchpad_tutorial_8" );
                        RepeatMessage( "launchpad_tutorial_8" );
						/*g_app->m_controlHelpSystem->AddOnScreenAid("button_ra", "button_control_shadow", 
							LANGUAGEPHRASE("control_help_lasers"), ControlUnitPrimaryFireDirected);*/
                        break;
        ...
        case 11:        g_app->m_sepulveda->HighlightBuilding( 129, "research" );
						...
						g_app->m_controlHelpSystem->AddOnScreenAid("button_x", "button_abxy_shadow", 
							LANGUAGEPHRASE("control_help_quickunitstart"), ControlIconsTaskManagerDisplayPressed);
						g_app->m_controlHelpSystem->AddOnScreenAid("button_la", "button_control_shadow", 
							LANGUAGEPHRASE("darwinia_tutorial_engineer"), ControlMenuDown);
						g_app->m_controlHelpSystem->AddOnScreenAid("button_a", "button_abxy_shadow", 
							LANGUAGEPHRASE("control_help_quickunitcreate"), ControlUnitCreate);
                        break;
        ...
        {
                        Building *research = g_app->m_location->GetBuilding(129);
                        g_app->m_camera->RequestBuildingFocusMode(research, 250, 150 );
                        g_app->m_camera->SetTargetFOV( 60 );
        ...
        case 16:        g_app->m_sepulveda->Say( "launchpad_tutorial_14" );
						...
						g_app->m_controlHelpSystem->AddOnScreenAid("button_rt", "button_trigger_shadow", 
							LANGUAGEPHRASE("darwinia_tutorial_grenade"), ControlUnitPrimaryFireTarget);
                        break;
    ...
    switch( m_chapter )
    {
        ...
        case 4:                     // Create a SQUAD
        {
            ...
            else if( currentTask && currentTask->m_type != GlobalResearch::TypeSquad )
            {
				...
				// Queue up the on screen help
				g_app->m_controlHelpSystem->AddOnScreenAid("button_x", "button_abxy_shadow", 
							LANGUAGEPHRASE("darwinia_tutorial_taskmanager"), ControlIconsTaskManagerDisplayPressed);
				g_app->m_controlHelpSystem->AddOnScreenAid("button_a", "button_abxy_shadow", 
							LANGUAGEPHRASE("darwinia_tutorial_createunit"), ControlUnitCreate);
            }
            break;
        }
        ...
        case 10:                        // Kill all virii 
        {
			...
			// We may have already gotten the research!
            //ASSERT_TEXT( building, "Tutorial building not found" );
        ...
        {  
            ...
            //ASSERT_TEXT( building, "Tutorial building not found" );
            int numFound;
            g_app->m_location->m_entityGrid->GetFriends( m_neighbours, building->m_pos.x, building->m_pos.z, 150.0f, &numFound, 2 );
        ...
        case 26:                        // Wipe out virii + centipede on island 2
        {
            ...
            if( currentUnit && currentUnit->m_troopType == Entity::TypeInsertionSquadie )
            {
				Building *script = g_app->m_location->GetBuilding( 6 );
				if( !script )
				{
					//if( GetHighResTime() - m_timer > 10.0 )
					{
						if( (currentUnit->m_centrePos - building->m_pos ).Mag() > 500.0f &&
							!g_app->m_sepulveda->IsTalking() )
						{
							g_app->m_sepulveda->Say( "launchpad_tutorial_clearincubator" );
						}
					}
				}
			}

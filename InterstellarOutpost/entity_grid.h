...
class EntityGrid
{
  ...
  public:
    ...
    void UpdateObject(WorldObjectId _objectId, double _oldWorldX, double _oldWorldZ, double _newWorldX, double _newWorldZ, double _radius);

    void GetNeighbours(std::vector<WorldObjectId>& _neighbours, double _worldX, double _worldZ, double _range, int* _numFound,
                       bool _includeTeam[NUM_TEAMS]);

    void GetNeighbours(std::vector<WorldObjectId>& _neighbours, double _worldX, double _worldZ, double _range, int* _numFound);

    void GetEnemies(std::vector<WorldObjectId>& _neighbours, double _worldX, double _worldZ, double _range, int* _numFound,
                    unsigned char _myTeam);

    WorldObjectId GetBestEnemy(double _worldX, double _worldZ, double _minRange, double _maxRange, unsigned char _myTeam);

    void GetFriends(std::vector<WorldObjectId>& _neighbours, double _worldX, double _worldZ, double _range, int* _numFound,
                    unsigned char _myTeam);
